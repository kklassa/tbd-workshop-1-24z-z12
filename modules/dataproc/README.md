...
| <a name="input_preeemptible_worker_count"></a> [preeemptible\_worker\_count](#input\_preeemptible\_worker\_count) | Number of preemptible worker nodes | `number` | `0` | no |
